...
public class MemberList extends servletBase {
	...
	protected String managerRequestForm(List<Member> memberList) {
		...
		List<String> tableRow2 = Arrays.asList("Display",dropDownMenu(memberList,"filterUser","all members"),
    	...
    	html += "<td><input type=" + formElement("submit") + "name=" + formElement("val")+"value=" + formElement("Change") + "></td></tr>";
    	html += "</table>";
    	html += "</form>";
    	return html;
	}
